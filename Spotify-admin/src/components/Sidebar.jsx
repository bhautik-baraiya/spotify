    ...
    return (
        <div className='bg-[#003A10] min-h-screen pl-[4vw]'>
            ...
            <NavLink to='/add-song' className="flex flex-col gap-5 mt-10 ">
                <div className="flex items-center gap-2.5 text-gray-500 bg-white border border-black p-2 pr-[max(8vw,10px)] drop-shadow-[-4px_4px_#00FF5B] text-sm font-medium ">
